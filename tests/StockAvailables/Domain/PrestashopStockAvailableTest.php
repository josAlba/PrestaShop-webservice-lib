...
namespace prestashop\prestashopWebserviceLib\Tests\StockAvailables\Domain;

use PHPUnit\Framework\TestCase;
use prestashop\prestashopWebserviceLib\StockAvailables\Domain\PrestashopStockAvailable;
